...
def test_ingest_then_query_flow(mock_process_file, mock_router_decision, mock_rag_pipeline):
    """
...
@patch('app.services.execute_rag_pipeline')
@patch('app.services.get_llm_router_decision')
def test_multiple_queries_flow(mock_router_decision, mock_rag_pipeline, mock_direct_llm):
    """
...
@patch('app.services.call_direct_llm')
@patch('app.services.get_llm_router_decision')
def test_error_recovery_flow(mock_router_decision, mock_direct_llm, mock_rag_pipeline):
    """
