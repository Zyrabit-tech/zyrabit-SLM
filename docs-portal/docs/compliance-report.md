...
## Key Metrics for Evidence Generation

- `zyrabit_security_hits_total`: Tracks potential PII (Personally Identifiable Information) exposure events.
- `zyrabit_token_latency_ms_per_token`: Monitors performance trends and service level objectives.
